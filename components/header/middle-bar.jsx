    ...
    <div className="bg-transparent py-4 px-4 lg:px-8">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <div className="flex items-center">
          <Link href="/">
          <img src="/assets/logo-header.png" alt="Eden Weave Foundation" className="h-24 " />
          </Link>
        ...
        <div className="hidden md:flex items-center gap-8">
          ...
          <Link href="/donate" className="bg-[#c4a35a] hover:bg-[#b8963f] text-white px-8 py-3 rounded font-semibold tracking-wider transition-colors">
            DONATE
          </Link>
        </div>
      </div>
